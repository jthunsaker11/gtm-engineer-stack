...
argument-hint: <ICP description> [seed: closed-won examples] [exclude: criteria] [offer: description] [--source <name>] [--motion <name>] [--enrich-all] [--execute] [--webhook-url <url>]
model: opus
---
