...
argument-hint: <ICP description> [seed: closed-won examples] [exclude: criteria] [offer: description] [--motion <name>] [--execute] [--webhook-url <url>]
model: opus
---
